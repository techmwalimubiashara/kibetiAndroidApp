...
public class MyAdapterLumpsum extends ArrayAdapter<DataClass> {

    Context context;
    List<DataClass> dataClassList;
    public MyAdapterLumpsum(@NonNull Context context, List<DataClass>dataClasses) {
        super(context, R.layout.data_item_lumpsum,dataClasses );
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_item_lumpsum,null,true);
