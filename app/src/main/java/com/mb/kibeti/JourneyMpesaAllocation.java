...
public class JourneyMpesaAllocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_journey_mpesa_allocation);
...
//      view = inflater.inflate(R.layout.fragment_inflow, container, false);
        ...
        this.setTitle("Tap any below to allocate");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(JourneyMpesaAllocation.this, MpesaSpending.class);
...
//        txtclose.setText("x");
        ...
        btnDetailedBudgetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myDialog.dismiss();
                Intent intent = new Intent(JourneyMpesaAllocation.this, AddOutflowActivity.class);
