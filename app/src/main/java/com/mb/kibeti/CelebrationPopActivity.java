...
public class CelebrationPopActivity extends AppCompatActivity {

    private KonfettiView konfettiView = null;
    private Shape.DrawableShape drawableShape = null;
    private WhatsAppSend whatsAppSend;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_celebration_pop);

        final Drawable drawable =
                ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_heart);

        whatsAppSend = new WhatsAppSend(this);

        drawableShape = new Shape.DrawableShape(drawable, true, true);

        whatsAppSend.sendMessage("Tracking your wealth");
...
//                        });
        findViewById(R.id.btnRain)
                .setOnClickListener(
                        v -> {
                            finish();
                            Intent intent = new Intent(CelebrationPopActivity.this,MpesaUpdates.class);
        ...
        findViewById(R.id.btnExit)
                .setOnClickListener(
                        v -> {
                            finish();
                            Intent intent = new Intent(CelebrationPopActivity.this,MainActivity.class);
                            startActivity(intent);
                        });
    }
