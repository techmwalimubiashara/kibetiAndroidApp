...
public class CLVAPentagon extends ArrayAdapter<FeedbackRowItem> {
    Context context;

    public CLVAPentagon(Context context, int resourceId, List<FeedbackRowItem> items) {
        super(context, resourceId, items);
        this.context = context;
    }

    private class ViewHolder {
        TextView tvAlpha, tvBeta, tvGamma, tvDelta, tvEpsilon;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.list_item_pentagon, null);
